...
public class LeaveService {
	...
	public boolean canApplyForLeaveThisMonth(int userId, LocalDate newLeaveStartDate, LocalDate newLeaveEndDate) {
		...
		int daysAlreadyTaken = leaveRequestDao.getTotalLeaveDaysInMonth(userId, newLeaveStartDate.getYear(),
				newLeaveStartDate.getMonthValue());

		// Check if the sum of already taken days and the new request's duration exceeds
		// the limit
