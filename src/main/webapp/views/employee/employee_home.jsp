...
<body class="d-flex">
    ...
    <div class="toast-container toast-notification">
        <c:if test="${not empty sessionScope.success_toast}">
            <div class="toast show align-items-center text-white bg-success border-0" role="alert" aria-live="assertive" aria-atomic="true">
                <div class="d-flex">
                    <div class="toast-body"><i class="bi bi-check-circle-fill me-2"></i> ${sessionScope.success_toast}</div>
        ...
        <c:if test="${not empty sessionScope.error_toast}">
            <div class="toast show align-items-center text-white bg-danger border-0" role="alert" aria-live="assertive" aria-atomic="true">
                <div class="d-flex">
                    <div class="toast-body"><i class="bi bi-exclamation-triangle-fill me-2"></i> ${sessionScope.error_toast}</div>
                    <button type="button" class="btn-close btn-close-white me-2 m-auto" data-bs-dismiss="toast" aria-label="Close"></button>
                </div>
            </div>
    ...
    <div class="d-flex flex-column flex-shrink-0 p-3 sidebar">
        ...
        <div>
            <span class="text-light small">Welcome, ${sessionScope.user.firstName}</span><br>
